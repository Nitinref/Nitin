...
export default function NitinPortfolio() {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText("nitinyadav484220@gmail.com")
    setIsCopied(true)
  ...
  // SOCIAL LINKS DATA
  const socialLinks = [
    { icon: Twitter, link: "https://x.com/NitinYa41170815", label: "Twitter" },
  ...
  // Updated Nav Items
  const navItems = ["About", "Skills", "Projects", "Education", "Resume", "Contact"]
  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300 relative overflow-x-hidden pb-32 md:pb-40">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 md:py-16 space-y-16 md:space-y-24">
        ...
        <section id="contributions" className="space-y-6 md:space-y-8">
        ...
        {/* EDUCATION SECTION */}
        <section id="education" className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start justify-between gap-4 md:gap-6">
              ...
              <img 
                src="/1.jpg" 
                alt="GGITS Logo" 
                className="w-16 h-16 sm:w-20 sm:h-20 object-contain flex-shrink-0 rounded-lg bg-white" 
              />
            </div>
        </section>
        ...
        <section id="resume" className="space-y-6">
          ...
          <div className={`
            relative p-6 rounded-2xl border backdrop-blur-sm transition-all group
            ${isDark 
          ...
          `}>
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Nitin Yadav_Resume.pdf</h3>
                  <p className="text-sm text-muted-foreground">Latest updated version</p>
                </div>
              </div>
        ...
        {/* --- NEW CONNECT / CONTACT SECTION --- */}
        <section id="contact" className="space-y-8 pt-8 border-t border-dashed border-gray-500/30">
          ...
          <div className={`
            p-4 sm:p-6 rounded-2xl border transition-all flex flex-col sm:flex-row gap-4 items-center justify-between
            ${isDark ? "bg-white/5 border-white/10" : "bg-gray-50 border-gray-200"}
          `}>
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className={`p-2.5 rounded-lg ${isDark ? "bg-green-500/20 text-green-400" : "bg-green-100 text-green-600"}`}>
                <Mail className="w-5 h-5" />
              </div>
              <span className="font-mono text-sm sm:text-base truncate">nitinyadav484220@gmail.com</span>
            </div>

            <button
              onClick={handleCopyEmail}
              className={`
                w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all
                ${isCopied 
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {socialLinks.map((item, idx) => (
              <a 
                ...
                rel="noopener noreferrer"
                className={`
                  flex flex-col items-center justify-center gap-2 p-4 rounded-xl border transition-all hover:-translate-y-1
                  ${isDark 
      ...
      <div className="fixed bottom-4 md:bottom-6 left-0 right-0 z-50 flex justify-center pointer-events-none px-4">
        <nav 
          className={`
            ...
            border shadow-xl max-w-max overflow-x-auto no-scrollbar
